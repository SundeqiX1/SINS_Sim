...
#include <math.h>
#include "ceshi20210723.h"
#include "ceshi20210723_private.h"
#include "ceshi20210723_dt.h"
...
const char *gblSlvrJacPatternFileName =
  "ceshi20210723_rsim_rtw\\ceshi20210723_Jpattern.mat";
...
void MdlInitializeSizes(void)
{
  ...
  ssSetNumBlocks(rtS, 2);              /* Number of blocks */
...
SimStruct * ceshi20210723(void)
{
  ...
  ssSetModelName(rtS, "ceshi20210723");
  ssSetPath(rtS, "ceshi20210723");
  ssSetTStart(rtS, 0.0);
  ...
  ssSetChecksumVal(rtS, 0, 1605408378U);
  ssSetChecksumVal(rtS, 1, 42846983U);
  ssSetChecksumVal(rtS, 2, 2351230214U);
  ssSetChecksumVal(rtS, 3, 1697931150U);
  return rtS;
}
